    ...
    <table class="table table-bordered" id="" width="100%">
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php if(!empty($siri)){
            echo '<td colspan="4" class="text-right"><b>Net Total</b></td><td colspan="4" class="text-center"><b>Rp '.number_format($orders['total_all'],2).'</b></td>';
          }else{
              echo '<td colspan="3" class="text-right"><b>Net Total</b></td><td colspan="3" class="text-center"><b>Rp '.number_format($orders['total_all'],2).'</b></td>';
          } ?>
        </tr>
      </tbody>
    </table>
