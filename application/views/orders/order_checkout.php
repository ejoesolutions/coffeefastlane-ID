	...
	<div class="col-md-6">
		...
		<div class="billing-details">
			...
			<div class="form-group">
				...
				<label class="white-color">Phone</label>
	...
	<div class="col-md-6">
		<div class="payments-methods">
			...
			<div>
				...
				<label for="payments-2" class="white-color">Online Banking</label>
			...
			<table class="shopping-cart-table table">
				...
				<tbody>
					...
					foreach ($this->cart->contents() as $items){
						...
						<tr>
							<td class="details">
								<a href="#" class="primary-color"><?= $items['name']; ?></a>
