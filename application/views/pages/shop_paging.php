...
<div class="media">
  ...
  <div class="media-body">
    <div class="col-md-5">
      <h3 class="media-heading primary-color">
        <?=  $seller['shop_name'] ?>
    ...
    <div class="col-md-3 h5">
      <h4 class="white-color">Products : <span class="text-choco"><?= ($pList) ? count($pList): 0 ?></span></h4>
      <h4 class="white-color">Contact : <span class="text-choco"><?= $seller['phone'] ?></span></h4>
    </div>
    <div class="col-md-3 h5">
      <h4 class="white-color">Joined : <span class="text-choco"><?= ($years) ? $years.' years' : '' ?> <?= ($months) ? $months.' months' : '' ?> <?= (!$months && !$years) ? $days.' days' : '' ?> ago</span></h4>
    </div>
  </div>
</div>
...
<div class="row">
    ...
    if ($this->uri->segment(2) && $this->uri->segment(3)) {
      ...
      <div class="section-title">
        <h3 class="primary-color">Products by <?php echo $seller['shop_name'] ?></h3>
      </div>
    <?php } ?>
    <?php 
    if ($this->uri->segment(2) && $this->uri->segment(3)) {
      echo "<h4 class='title primary-color'>More Products by ".$seller['shop_name']."</h4>";
    } ?>
  </div>
  <!-- section title -->
