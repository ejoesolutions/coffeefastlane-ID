<div class="row">
  ...
  <div class="col-md-6">
    <div class="product-body">
      ...
      <br>
      <p><strong>Shop Name:</strong><a href="<?= base_url('') ?><?= $p_detail['shop_url'] ?>" class="white-color"> <?= $p_detail['shop_name'] ?></a></p>
      <p class="white-color"><strong>Availability:</strong> In Stock [ <?= $p_detail['stock'] ?> ]</p>
      <p class="white-color"><strong>Product Code:</strong> <?= $p_detail['item_code'] ?></p>
      <hr>
      <div class="product-btns">
        <div class="qty-input">
          <span class="text-uppercase white-color">QTY: </span>
          <input type="number" name="qty" class="input text-center white-color" min="1" max="<?php echo $p_detail['stock'] ?>" value='1'>
        </div>
    ...
    <div class="tab-content">
      <div id="tab1" class="tab-pane fade in active">
        ...
        <p class="white-color"><?php echo 'Weight :';  ?>
          ...
          <p>
          <span class="white-color" style="white-space: pre-wrap;word-wrap: break-word;"><?php echo $p_detail['description']; ?></span>
        </p>
      </div>
    </div>
  </div>
