...
<div class="row">
  ...
  <div class="col-md-7">
    <div class="product-body">
      ...
      <h2 class="product-name primary-color"><?= $p_detail['product_name'] ?></h2>
      <h1 class="product-price-detail">
        ...
        if($p_detail['discount']!=null){
          ...
          echo '<del style="color:#AEB6BF">'.$currency['tag'].' '.$p_detail['add_cost'].'</del><br>';
      ...
      <br>
      <p class="white-color"><strong class="primary-color">Shop Name:</strong> <?= $p_detail['shop_name'] ?></p>
      <p class="white-color"><strong class="primary-color">Availability:</strong> In Stock [ <?= $p_detail['stock'] ?> ]</p>
      <p><strong class="primary-color">Product Code:</strong> <span style="color:#ffff"><?= $p_detail['item_code'] ?></span></p>
      <hr>
      <div class="product-btns">
        <div class="qty-input">
          <span class="white-color">QTY: </span>
          <input type="number" name="qty" class="input text-center white-color" min="1" max="<?= $p_detail['stock'] ?>" value='1'>
        </div>
...
<div>
  ...
  <p class="white-color"><?php echo 'Weight :';  ?>
    <?php
    ...
    <p class="white-color"><?php echo $p_detail['description']; ?></p>
  </p>
</div>
