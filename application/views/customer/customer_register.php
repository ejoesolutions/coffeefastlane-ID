	...
	<div class="col-md-6">
		<div class="">
			...
			<div class="form-group">
				<label class="control-label white-color">Username</label>
				<input class="form-control" type="text" name="identity" placeholder="Username/Email" required autocomplete="off">
			</div>
			<div class="form-group">
				<label class="control-label white-color">Password</label>
			...
			<div class="form-group">
				<table width="100%">
					<tr>
						...
						<td align="right" class="white-color">Forgot Password? <a class="primary-color" data-toggle="modal" href="#forgotPswd"><b>Reset Here<b></a></td>
					</tr>
				</table>
			</div>
			<?= form_close() ?>
