<div class="row">
	...
	<div class="col-md-10">
		...
		<table class="" border=0  width="100%">
			...
			<tr>
				<td class="primary-color">Name</td><td class="white-color"><?= $ship['ship_name'] ?></td>
			</tr>
			<tr>
				<td class="primary-color">Phone</td><td class="white-color"><?= $ship['ship_phone'] ?></td>
			</tr>
			<tr>
				<td class="primary-color">Address</td><td class="white-color"><?= $ship['ship_address'].'<br>'.$ship['ship_postcode'].' '.$ship['ship_area']
				// .'<br>'.$ship['state'] ?>
				</td></td>
			</tr>
			<tr>
