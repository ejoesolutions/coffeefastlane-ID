	...
	<div class="col-md-10">
		...
		<table class="table">
			...
			<tr>
				...
				<td>
					<div class="pull-left white-color">
			...
			<tr>
				...
				<td class="white-color"><?= $user_profile['username'] ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="white-color"><?= $user_profile['full_name'] ?></td>
			</tr>
			<tr>
				<td class="primary-color">Phone</td>
				<td class="white-color"><?= $user_profile['phone'] ?></td>
			</tr>
			<tr>
				<td class="primary-color">Email</td>
				<td class="white-color"><?= $user_profile['email'] ?></td>
			</tr>
			<tr>
				<td class="primary-color">Address</td>
				<td class="white-color"><?= $user_profile['address'].'<br>'.$user_profile['postcode'].' '.$user_profile['town_area']
